...
function new (input virtual router_if.tb_mod_port vif_in,input virtual router_if.tb_mon vif_mon_in,input virtual router_if.tb_mon vif_mon_out);
...
//Section T7.2: Construct object for environment and connect interfaces
env.build();
endfunction
